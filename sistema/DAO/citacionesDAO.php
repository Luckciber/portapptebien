...
class CitacionesDao {
    ...
    public function agregarCitacion($id_alumno, $id_usuario, $fecha_creacion, $motivo, $fecha_citacion) {
    ...
    public function actualizarCitacion($id_citacion, $motivo, $fecha_citacion) {
        $sql = "UPDATE citaciones SET motivo = :motivo, fecha_citacion = :fecha_citacion WHERE id_citacion = :id_citacion";
        try {
            $stmt = $this->pdo->prepare($sql);
            $stmt->bindParam(':id_citacion', $id_citacion);
            $stmt->bindParam(':motivo', $motivo);
